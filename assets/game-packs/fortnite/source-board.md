# Fortnite production source board

- Clean Era order: 3
- Genre: battle-royale
- Environment grammar: storm
- Palette roles: #8d55e8, #43d6dc, #24304f
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Fortnite official-source section).
