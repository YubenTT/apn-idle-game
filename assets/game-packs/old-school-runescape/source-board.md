# Old School RuneScape production source board

- Clean Era order: 8
- Genre: mmorpg
- Environment grammar: lava
- Palette roles: #e27832, #8c5b42, #2c2020
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Old School RuneScape official-source section).
