# Overwatch production source board

- Clean Era order: 10
- Genre: hero-shooter
- Environment grammar: future
- Palette roles: #e9a24f, #6dc6e6, #263249
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Overwatch official-source section).
