# League of Legends production source board

- Clean Era order: 2
- Genre: moba
- Environment grammar: river
- Palette roles: #c99b3b, #29a3a3, #282447
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (League of Legends official-source section).
