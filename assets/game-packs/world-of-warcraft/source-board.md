# World of Warcraft production source board

- Clean Era order: 4
- Genre: mmorpg
- Environment grammar: ice
- Palette roles: #63b8d6, #7b58b8, #1e2d43
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (World of Warcraft official-source section).
