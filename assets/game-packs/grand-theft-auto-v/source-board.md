# Grand Theft Auto V production source board

- Clean Era order: 11
- Genre: open-world-action
- Environment grammar: heist
- Palette roles: #d35f74, #65b79a, #252636
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Grand Theft Auto V official-source section).
