# Path of Exile 2 production source board

- Clean Era order: 16
- Genre: action-rpg
- Environment grammar: ruin
- Palette roles: #b44d35, #d18345, #2f2021
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Path of Exile 2 official-source section).
