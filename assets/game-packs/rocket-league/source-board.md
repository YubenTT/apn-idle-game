# Rocket League production source board

- Clean Era order: 19
- Genre: sports-driving
- Environment grammar: arena
- Palette roles: #4da9e8, #e87936, #172a42
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Rocket League official-source section).
