# Dead by Daylight production source board

- Clean Era order: 15
- Genre: asymmetric-horror
- Environment grammar: fog
- Palette roles: #a94e5d, #8b91a0, #211d29
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Dead by Daylight official-source section).
