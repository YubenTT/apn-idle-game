# Escape from Tarkov production source board

- Clean Era order: 18
- Genre: extraction-shooter
- Environment grammar: mall
- Palette roles: #a7956e, #6f8069, #242924
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Escape from Tarkov official-source section).
