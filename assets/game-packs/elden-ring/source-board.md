# Elden Ring production source board

- Clean Era order: 20
- Genre: action-rpg
- Environment grammar: castle
- Palette roles: #c5a35a, #788660, #29291f
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Elden Ring official-source section).
