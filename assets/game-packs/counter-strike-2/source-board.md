# Counter-Strike 2 production source board

- Clean Era order: 7
- Genre: tactical-shooter
- Environment grammar: tactical
- Palette roles: #d7a15f, #5c9ad4, #2d2b2c
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Counter-Strike 2 official-source section).
