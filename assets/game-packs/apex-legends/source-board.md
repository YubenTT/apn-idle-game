# Apex Legends production source board

- Clean Era order: 13
- Genre: battle-royale
- Environment grammar: industrial
- Palette roles: #da584c, #d9aa63, #30262a
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Apex Legends official-source section).
