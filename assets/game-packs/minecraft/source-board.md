# Minecraft production source board

- Clean Era order: 6
- Genre: sandbox-survival
- Environment grammar: blocks
- Palette roles: #74b94f, #9a79c7, #293922
...
- Research owner: `docs/GAME-PACK-ASSET-BIBLE.md` (Minecraft official-source section).
